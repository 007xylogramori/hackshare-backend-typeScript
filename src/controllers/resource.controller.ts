...
export const uploadResource = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    throw new ApiError(
      500,
      (error as Error)?.message  || "An error occurred while uploading the resource."
    );
  }
});
...
export const getResources = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    throw new ApiError(500, (error as Error)?.message ||" Something went wrong while fetching resources.");
  }
});
...
export const deleteResource = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    throw new ApiError(
      500,
      (error as Error)?.message || "An error occurred while deleting the resource."
    );
  }
});
